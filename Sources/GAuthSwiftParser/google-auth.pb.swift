...
struct MigrationPayload {
  ...
  struct OtpParameters {
    ...
    var secret: Data = SwiftProtobuf.Internal.emptyData
...
extension MigrationPayload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.otpParameters)
      case 2: try decoder.decodeSingularInt32Field(value: &self.version)
      case 3: try decoder.decodeSingularInt32Field(value: &self.batchSize)
      case 4: try decoder.decodeSingularInt32Field(value: &self.batchIndex)
      case 5: try decoder.decodeSingularInt32Field(value: &self.batchID)
      default: break
      }
    }
  }
...
extension MigrationPayload.OtpParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBytesField(value: &self.secret)
      case 2: try decoder.decodeSingularStringField(value: &self.name)
      case 3: try decoder.decodeSingularStringField(value: &self.issuer)
      case 4: try decoder.decodeSingularEnumField(value: &self.algorithm)
      case 5: try decoder.decodeSingularInt32Field(value: &self.digits)
      case 6: try decoder.decodeSingularEnumField(value: &self.type)
      case 7: try decoder.decodeSingularInt64Field(value: &self.counter)
      default: break
      }
    }
  }
